...
class Widget5:
    ...
    def show():
        widget5 = [
            ...
            [sg.Radio('Resolvido', group_id='status',key='Resolvido'),sg.Radio('Pendente',group_id='status',key='Pendente'), sg.Radio('Manutenção',group_id='status',key='Manutenção'),sg.Radio('Troca',group_id='status',key='Troca') ],
